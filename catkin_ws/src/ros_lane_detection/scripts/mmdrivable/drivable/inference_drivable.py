...
class inference_test:
    def __init__(self):
        self.url = "https://dl.cv.ethz.ch/bdd100k/drivable/models/"
        self.ext = "pth"
        self.config_file_base = (
            "/home/mobilitylab/catkin_ws/src/ros_lane_detection/scripts/mmdrivable/drivable/configs/drivable/"
        )
...
def test_multimodel_video():
    ...
    #checkfiles = infer_test.listFD()
    #print(checkfiles)
    checkfiles = ['apcnet_r50-d8_512x1024_80k_drivable_bdd100k.pth',
    'deeplabv3+_r101-d8_512x1024_80k_drivable_bdd100k.pth',
    'fcn_hr48_512x1024_80k_drivable_bdd100k.pth',
    'ccnet_r50-d8_512x1024_80k_drivable_bdd100k.pth',
    'dmnet_r50-d8_512x1024_40k_drivable_bdd100k.pth',  
    'dnl_r50-d8_512x1024_80k_drivable_bdd100k.pth', 
    'psanet_r50-d8_512x1024_80k_drivable_bdd100k.pth',   
    'upernet_swin-t_512x1024_80k_drivable_bdd100k.pth']

    torch.cuda.set_device(1)
    for checkfile in checkfiles[6:]:
        modelname = str(checkfile).split(".")[0]
        print(modelname)
        config_file = infer_test.config_file_base + modelname + ".py"
        load_from = infer_test.url + modelname + ".pth"
        ...
        for frame in infer_test.paths[:4000]:
            start = time.monotonic()
