...
class benchmark_argparser():
    def __init__(self):
        ...
        benchmark_group.add_argument('--all', dest='all', help='all models from DropBox will be downloaded',
                                      action='store_true')
        self.parser.add_argument('--jetson_devkit', dest='jetson_devkit', default='xavier', help='Input Jetson Devkit name', type=str)
        ...
        self.parser.add_argument('--jetson_clocks', dest='jetson_clocks', help='Set Clock Frequency to Max (jetson_clocks)',
                                      action='store_true')
        self.parser.add_argument('--gpu_freq', dest='gpu_freq', default=1377000000,help='set GPU frequency', type=int)
        ...
        self.parser.add_argument('--dla_freq', dest='dla_freq', default=1395200000, help='set DLA frequency', type=int)
        # Default values are for Xavier-NX
