...
#include <ros_referee/AveragingAction.h>
...
protected:
  ...
  ros::NodeHandle nh_;
  actionlib::SimpleActionServer<ros_referee::AveragingAction> as_;
  std::string action_name_;
  int data_count_, goal_;
  float sum_, sum_sq_;
  ros_referee::AveragingFeedback feedback_;
  ros_referee::AveragingResult result_;
  ros::Subscriber sub_;
};
