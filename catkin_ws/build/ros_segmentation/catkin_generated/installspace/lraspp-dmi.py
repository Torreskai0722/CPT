...
class lraspp_node:
    ...
    def __init__(self):
        ...
        classes = 20
        weights_path = "/home/mobilitylab/projects/deep-learning-for-image-processing/pytorch_segmentation/lraspp/lraspp_mobilenet_v3_large.pth"
        palette_path = "/home/mobilitylab/projects/deep-learning-for-image-processing/pytorch_segmentation/lraspp/palette.json"
        ...
        self.model = lraspp_mobilenetv3_large(num_classes=classes+1)
        ...
        self.status_pub = rospy.Publisher('lraspp_status', ProcessStatus, queue_size=1)
        print("ready")
