...
class maskrcnn_node:
    ...
    def __init__(self):
        ...
        # create model
        # self.model = torchvision.models.detection.maskrcnn_resnet50_fpn(num_classes=21)
        self.model = torchvision.models.detection.maskrcnn_resnet50_fpn(pretrained=True)
        # train_weights = "/home/mobilitylab/projects/PDNN/catkin_ws/src/ros_object_detection/scripts/mask_rcnn/model_25.pth"
        ...
        original_img = cv2.imread("../faster_rcnn/test.jpeg", cv2.IMREAD_COLOR)
